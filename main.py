...
# Purpose:      to help peopel with thier budget
#
# Author:      Adam Buchan
#
#-------------------------------------------------------------------------------
...
app4=Window(app,title="error",height=75,width=300)    
app5=Window(app,title="Error",height=75,width=300)
app6=Window(app,title="start screen")
app7=Window(app,title="Income")
app8=Window(app,title="Error",height=75,width=300)
app9=Window(app,title="Error",height=75,width=300)
app10=Window(app,title="Expenses")
app11=Window(app,title="Error",height=75,width=300)
app12=Window(app,title="show")
app13=Window(app,title="Error",height=75,width=300)
app14=Window(app,title="Error",height=75,width=300)
...
def income():
    t10.clear()
    t10.append(text="you should type in the amount of income \ngotten and when you got it \nand if you want a description")
    if tb5.value.isnumeric()==False:
        t10.clear()
        t10.append(text="income must be numbers only")
    else:
...
def expenses():
    t=True
    t14.clear()
    t14.append(text="Add your expenses, the \ndate you paid it and if\n you want a description")
    if tb10.value.isnumeric()==False:
            t14.clear()
            t14.append(text="Number only for expenses")
...
def goal():
    ...
    if tb14.value.isnumeric()==True:
        t25.clear()
        t25.append(text="set a goal for the mounth")
        ...
        t25.clear()
        t25.append(text="must be numbers")
...
t20=Text(app13,text="date must be in format \nDD/MM/YYYY and numbers")
b8=PushButton(app13,text="Ok",command=incomescreen)
t21=Text(app14,text="date must be in format \nDD/MM/YYYY and must be numbers")
